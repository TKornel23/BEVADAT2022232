...
# %%
def create_array(input: tuple):
    return np.zeros(input)
...
# %%
def do_transpose(input):
    return np.array(input).transpose(1, 0)
...
# %%
def round_array(input_list, rounding = 2):
    return np.array(input_list).round(rounding)
...
# %%
def bool_array(input):
    return np.array(input).astype(bool)
...
# %%
def invert_bool_array(input):
    return np.array(input).astype(bool).__invert__()
